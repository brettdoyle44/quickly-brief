...
import UploadIcon from "./SvgIcon/ImgIcon";
...
export default function (props: {
  ...
  const onLogoChange = (e: { target: { files: any[] } }) => {
  ...
  const onOpenChange = (o: boolean | ((prevState: boolean) => boolean)) => {
    setOpen(o);
  };
  ...
  return (
    <aside className="w-full border-l sm:w-96 fixed z-50 top-0 right-0 h-full overflow-y-auto bg-gray-50 pt-8 pb-8 lg:sticky lg:z-auto scroll-gradient-bottom">
      ...
      <div className="space-y-12">
        <div className="px-6">
          <span className="block text-xs font-medium tracking-wide text-gray-400 uppercase mb-2">
            Form
          </span>
            ...
            <div className="space-y-6">
              <div className="relative">
                <div className="flex">
                  <label
                    htmlFor="name"
                    className="font-semibold text-gray-500 leading-snug tracking-tight mb-2"
                  >
                    Title
                  </label>
                </div>
                <div className="relative">
                  <input
                    ...
                    value={form.name}
                    onChange={(e) => {
                      props.setFormValue(e.target.value, "name");
                    }}
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <input
                    ...
                    value={form.slug}
                    onChange={(e) => {
                      props.setFormValue(e.target.value, "slug");
                    }}
                    className="theme-border theme-ring block w-full px-4 py-2 pr-8 md:pr-4 border rounded text-gray-900 transition-colors duration-100 ease-out appearance-none focus:outline-none"
                  />
                </div>
        ...
        <div className="px-6">
          <div className="text-xs font-medium tracking-wide text-gray-400 uppercase mb-2">
            After completion
          </div>
          <div className="space-y-6">
            <div className="flex items-center">
              <Switch.Root
                ...
                className={`relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out
                  duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-300 ${
                    redirect ? "bg-black" : "bg-gray-200"
                  }`}
              >
                <Switch.Thumb
                  ...
                  bg-white shadow transform ring-0 transition ease-in-out duration-200 ${
                    redirect ? "translate-x-5" : "translate-x-0"
                  }`}
                />
              </Switch.Root>
              <div className="flex">
                <label
                  className="font-semibold text-gray-600 leading-snug tracking-tight ml-2"
                  htmlFor="redirect-switch"
                >
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <input
                    ...
                    value={form.redirect}
                    onChange={(e) => {
                      props.setFormValue(e.target.value, "redirect");
                    }}
                    className="theme-border theme-ring block w-full px-4 py-2 pr-8 md:pr-4 border rounded text-gray-900 transition-colors duration-100 ease-out appearance-none focus:outline-none"
                  />
                </div>
        ...
        <div className="px-6">
          ...
          <div className="space-y-6">
            <div className="relative">
              ...
              <div
                className="relative cursor-pointer bg-white border rounded px-4 py-8 focus:outline-none focus:ring focus:ring-blue-300 focus:border-blue-400 focus:border-solid border-gray-400 border-dashed"
                tabIndex={0}
            ...
            {form.branding.logo ? (
              <div className="relative">
                <div className="flex">
                  <label className="font-semibold text-gray-500 leading-snug tracking-tight mb-2">
                    Logo size
                  </label>
                </div>
                  ...
                  {sizeList.map((item) => {
                    return (
                      <button
                        key={item.value}
                        onClick={() => {
                          props.setFormBrandValue(item.value, "logoSize");
                        }}
                        className={`flex flex-1 justify-center items-center px-2 py-1 bg-white border-2
                            ...
                            ${
                              item.value === form.branding.logoSize
              ...
              <div className="flex items-center space-x-4">
                <div className="relative flex-1">
                  <input
                    ...
                    onChange={(e) => {
                      props.setFormBrandValue(e.target.value, "primary_color");
                    }}
                    className="theme-border theme-ring block w-full px-4 py-2 pr-8 md:pr-4 border rounded text-gray-900 transition-colors duration-100 ease-out appearance-none focus:outline-none"
                  />
                </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="relative flex-1">
                  <input
                    ...
                    onChange={(e) => {
                      props.setFormBrandValue(e.target.value, "button");
                    }}
                    className="theme-border theme-ring block w-full px-4 py-2 pr-8 md:pr-4 border rounded text-gray-900 transition-colors duration-100 ease-out appearance-none focus:outline-none"
                  />
                </div>
